...
public class CameraController : MonoBehaviour
{
    ...
    private void Zoom()
    {
        //There will be two mods.
        //Fov zooming and distancial zooming.
        switch (customCameras[activeCameraIndex].cameraType)
        {
            //Distancial
            case CustomCamera.CameraType.TP:
                var b = customCameras[activeCameraIndex];
                var positionZAbs = Mathf.Abs(b.thisCamera.transform.localPosition.z); 
                //Quick solution: instead of getting the sign of the z value. We will just subtract it.
                positionZAbs -= InputManager.instance.GetInput("CameraZoom") != 0 ? Mathf.Sign(InputManager.instance.GetInput("CameraZoom")) : 0;
                positionZAbs = Mathf.Clamp(positionZAbs, b.minZoom, b.maxZoom);
                b.thisCamera.transform.localPosition = new Vector3(0, 0, Mathf.Sign(b.thisCamera.transform.localPosition.z) * positionZAbs);
                break;


            //Fov
            case CustomCamera.CameraType.Free:
            ...
            case CustomCamera.CameraType.POV:
                ...
                customCameras[activeCameraIndex].thisCamera.fieldOfView = Mathf.Clamp(a.thisCamera.fieldOfView, a.minZoom, a.maxZoom);
                break;
